...
public class Calculator implements ActionListener {
    ...
    String[] functionButtonsLabels = { "+", "-", "*", "/", ".", "=", "Del", "Clr", "(-)" };
    ...
    Calculator() {
        ...
        // Set the textfield background color to black and text color to white
        ...
        for (int i = 0; i < 9; i++) {
            functionButtons[i] = createButton(functionButtonsLabels[i]);
        }
    ...
    private JButton createNumberButton(String label) {
        ...
        button.setForeground(new Color(0, 0, 139)); // Set text (number) color to dark blue
        return button;
    }
